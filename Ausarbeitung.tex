...
\begin{figure}[H]
\centerline{
\includegraphics[width=0.9\columnwidth]{Abbildungen/Browse.png}
}
\caption {Das Tool nachdem die Datei mittels \textit{Browse}-Button ausgewählt wurde}
\label{browse}
\end{figure}
...
\subsection{Plotten aller Daten}

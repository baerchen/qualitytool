...
Damit das Tool auf Rechner funktioniert müssen dort einige Vorinstallationen gemacht werden. Neben der Software die bereits für die erste Version des Tools benötigt wird (siehe Praktikumsbericht ``Quality Control Tool for Different Accelerometer Data'' von Johannes Eder, Martin Attenhofer), wird jetzt auch die \textsc{Matlab} \textbf{Signal Processing Toolbox} benutzt.

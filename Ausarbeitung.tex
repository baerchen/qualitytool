...
An der Darstellung des \textit{Plots} für Counts hat sich nichts Wesentliches im Vergleich zur ersten Version des Tools verändert. Nur die Beschriftung wurde, genauso wie bei einem \textit{Plot} von Rohdaten, angepasst. Außerdem wurde die Position der Ticks, wie später für Rohdaten beschrieben, ein wenig abgeändert.\newline
...
Um das QualityControlTool um weitere Funktionalitäten zu vergrößern oder um es zu verbessern wird neben der in Kapitel \ref{Hinweise} erwähnten Software auch die \textsc{Matlab} \textbf{Signal Processing Toolbox\footnotemark}

...
/TODO: Bild einer Beispieldatei nach dem Browsen 

\subsubsection{Beteiligte \textsc{Java}- und \textsc{Matlab}- Funktionen}

/TODO: alle FUnktionen erklären


\subsection{Der Load-Button}
Der Load-Button wird dem Benutzer erst nach dem Ausführen des \textit{Browse}-Vorgangs freigeschaltet.

\subsubsection{Möglichkeiten für den Benutzer}
Die Trennung des Browse-Buttons und des Load-Buttons erlaubt dem User vom Programm selbstsändig vorgenommene Einstellungen zu überprüfen und gegebenenfalls zu verifizieren.

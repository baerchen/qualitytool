...
\begin{figure}[H]
\centerline{
\includegraphics[width=150mm, height=95mm]{Abbildungen/Browse-Button.png}
}
...
\begin{figure}[H]
\centerline{
\includegraphics[width=135mm, height=100mm]{Abbildungen/Plot.png}
}
...
Damit das Tool auf Rechner funktioniert müssen dort einige Vorinstallationen gemacht werden. Neben der Software die bereits für die erste Version des Tools benötigt wird (TODO: Verweis einfügen zu Dokumentation von Jungs), wird jetzt auch die \textsc{Matlab} \textbf{Signal Processing Toolbox} benutzt.
...
\begin{figure}[H]
\centerline{
\includegraphics[width=150mm, height=100mm]{Abbildungen/Browse.JPG}
}
...
\begin{figure}[H]
\centerline{
\includegraphics[width=150mm, height=100mm]{Abbildungen/Load.JPG}
}
...
\begin{figure}[H]
\centerline{
\includegraphics[width=150mm, height=100mm]{Abbildungen/RawToCounts.JPG}
}
...
\begin{figure}[H]
\centerline{
\includegraphics[width=150mm, height=100mm]{Abbildungen/FirstPlot.JPG}
}
\caption {Erster Plot}
\label{firstPlot}
\end{figure}
...
\begin{figure}[H]
\centerline{
\includegraphics[width=150mm, height=100mm]{Abbildungen/SecondPlot.JPG}
}
...
\begin{figure}[H]
\centerline{
\includegraphics[width=150mm, height=100mm]{Abbildungen/Cut.JPG}
}
...
\begin{figure}[H]
\centerline{
\includegraphics[width=150mm, height=100mm]{Abbildungen/SecondPlot_RAW.JPG}
}
...
\begin{figure}[H]
\centerline{
\includegraphics[width=150mm, height=100mm]{Abbildungen/wearingTimevH.JPG}
}
